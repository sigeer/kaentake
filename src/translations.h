...
// 注：索引对应游戏字符串池中的位置，不设置翻译则保持原英文
inline const StringTranslation g_StringTranslations[] = {
    { 10, "装备" },
    { 11, "设置" },
    { 12, "新手" },
    { 13, "战士" },
    ...
    { 102, "冒险岛错误：精灵公共槽失败。" },
    { 103, "冒险岛错误：精灵初始化失败(空)。" },
    { 104, "冒险岛错误：精灵初始化失败(未知)。" },
    { 105, "冒险岛错误：MapleTV初始化失败。" },
    { 106, "冒险岛错误：任务管理器初始化失败。" },
    { 107, "冒险岛错误：物品信息错误。" },
    { 108, "冒险岛错误：技能信息错误。" },
    { 109, "冒险岛错误：加载怪物技能失败。" },
    { 110, "冒险岛错误：加载商品失败。" },
    { 111, "冒险岛错误：加载包失败。" },
    { 112, "冒险岛错误：商城失败(type1)。" },
    { 113, "冒险岛错误：商城失败(type2)。" },
    { 114, "冒险岛错误：可拖拽物品错误。" },
    { 115, "冒险岛错误：雇员错误。" },
    { 116, "冒险岛错误：怪物错误。" },
    { 117, "冒险岛错误：NPC错误。" },
    { 118, "冒险岛错误：宠物错误。" },
    { 119, "冒险岛错误：召唤错误。" },
    { 120, "冒险岛错误：动作管理器错误(type1)。" },
    { 121, "冒险岛错误：动作管理器错误(type2)。" },
    { 268, "新手版无法使用世界地图。\r\n请从maplestory.nexon.net下载完整客户端以使用此功能。" },
    { 269, "访客ID玩家无法使用世界地图。\r\n请从maplestory.nexon.net下载完整客户端。" },
    { 274, "效果正在进行中。\r\n请稍后再试。" },
    { 391, "您登录的角色\r\n尚未请求更改名称。" },
    { 520, "请按检查按钮\r\n确认是否可以使用\r\n该角色名。" },
    { 522, "这适用于请求的限制。\r\n请检查您是否在最近3个月内\r\n被封禁过。" },
    ...
    { 526, "您的改名请求\r\n已成功提交。" },
    { 544, "此优惠券仅可在\r\nNexon合作网吧使用。\r\n请使用Nexon合作网吧。" },
    { 545, "此优惠券是Nexon合作网吧专用券，\r\n且已被使用过。" },
    { 546, "此优惠券是Nexon合作网吧专用券，\r\n且已过期。" },
    { 548, "您已连续输入错误\r\n优惠券号码三次，\r\n已与商城断开连接。" },
    { 674, "[当前等级 %d]" },
    { 675, "[下一等级 %d]" },
    { 866, "无法取回道具\r\n因为存在只能\r\n获取一次的道具。" },
    ...
    { 2371, "CRC信息已过时" },
    { 2507, "此道具无法移动。" },
    { 3274, "这是NX优惠券号码。\r\n请在www.nexon.net注册您的优惠券。" },
    { 3345, "试用版中无法使用商城。" },
    { 3346, "下载完整客户端来个性化您的角色！" },
    { 3351, "GameGuard：初始化错误 (%d)\r\n\r\n" },
    { 3352, "GameGuard已在运行。请重新启动并重试。" },
    { 3353, "客户端已运行多次，或GameGuard已打开。请关闭游戏并重新启动客户端。" },
    { 3354, "重置GameGuard时发生错误。请尝试重新启动系统后重启客户端，或关闭可能有冲突的程序。建议运行病毒/间谍软件扫描。" },
    { 3355, "GameGuard文件损坏或缺失。建议运行GameGuard安装程序解决。" },
    { 3356, "Windows系统文件损坏。建议进行病毒检查，并升级/重新安装Internet Explorer。" },
    { 3357, "执行GameGuard时发生错误。请重新安装GameGuard后重启客户端。" },
    { 3358, "检测到黑客程序。请关闭所有不必要的程序后重新打开游戏。" },
    { 3359, "您在更新过程中按了取消。如果是由于连接问题，请检查网络连接和防火墙设置。" },
    { 3360, "检测到您的计算机上安装的程序与GameGuard冲突。" },
    { 3361, "无法连接到GameGuard更新服务器。请稍后重试或检查网络连接。" },
    { 3362, "更新过程中发生错误。请尝试临时关闭杀毒软件后重启客户端。" },
    { 3363, "加载病毒/黑客工具搜索时发生错误。可能是由于内存不足或病毒感染。" },
    { 3364, "处理GameGuard时发生错误。请联系客服。" },
    { 3365, "检测到黑客程序。如果您认为这是误报，请联系客服。" },
    { 3381, "您的举报已成功登记。\r\n本周还剩%d次举报机会。" },
    { 3382, "您的举报已成功登记。\r\n本周已无剩余举报次数。" },
    { 3383, "举报已成功提交。\r\n今天内不能再举报。" },
    { 3530, "请重新确认您输入的手机运营商。" },
    ...
    { 3997, "您已超过可以赠送道具的\r\n时间限制。" },
    { 3998, "由于技术问题，\r\n此道具无法赠送。\r\n请稍后再试。" },
    { 3999, "宠物未装备，或此道具不适用于您的宠物。" },
    { 4000, "双击道具进行预览。" },
    { 4001, "从%02d:00到%02d:00" },
    { 4002, "无法转移等级低于20的角色。" },
    { 4003, "无法转移\r\n当前已结婚的角色。" },
    { 4004, "无法转移\r\n当前是公会会长的角色。" },
    { 4005, "无法将角色转移到\r\n当前所在的相同世界。" },
...
inline const char* GetTranslation(int index) {
    for (const auto& entry : g_StringTranslations) {
        if (entry.index == index && entry.chinese != nullptr) {
...
// 翻译映射表（用于运行时查找）
inline std::unordered_map<int, const char*>& GetTranslationMap() {
    static std::unordered_map<int, const char*> translationMap;
    if (translationMap.empty()) {
        for (const auto& entry : g_StringTranslations) {
            if (entry.index != 0 && entry.chinese != nullptr) {
                translationMap[entry.index] = entry.chinese;
            }
        }
    }
